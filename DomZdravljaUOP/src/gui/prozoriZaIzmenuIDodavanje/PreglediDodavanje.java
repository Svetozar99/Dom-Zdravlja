...
public class PreglediDodavanje extends JFrame {
	...
	public PreglediDodavanje(DomZdravlja domZdravlja, Pregled pregled) {
	...
	private void initGUI() {
		...
		for(Pacijent pacijent:this.domZdravlja.getPacijenti()) {
			cbPacijent.addItem(pacijent.getKorIme());
		}
		...
		btnOK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(validacija() == true) {
					...
					Pacijent pacijent = domZdravlja.nadjiPacijenta(pacijentKorIme);
					...
					PreglediDodavanje.this.dispose();
					PreglediDodavanje.this.setVisible(false);
				}
			}
		});
	}
