...
public class GlavniProzorZaLekare extends JFrame {
	...
	public GlavniProzorZaLekare(DomZdravlja domZdravlja, Korisnik prijavljeniKorisnik) {
	...
	public void initListeners() {
		preglediItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				PreglediZaLekara pp = new PreglediZaLekara(domZdravlja, prijavljeniKorisnik);
				pp.setVisible(true);
